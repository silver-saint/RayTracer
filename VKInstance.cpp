...
{
	bool result = glfwCreateWindowSurface(instance, window, nullptr, &surface) != VK_SUCCESS;
	if (result)
	{
...
void VKApp::CreateRenderPass()
{
	...
	bool result = vkCreateRenderPass(device, &renderPassInfo, nullptr, &renderPass) != VK_SUCCESS;
	if (result) {
